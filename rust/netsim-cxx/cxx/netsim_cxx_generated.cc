...
namespace netsim {
  namespace frontend {
    using CxxServerResponseWriter = ::netsim::frontend::CxxServerResponseWriter;
  }
}
...
namespace frontend {
extern "C" {
void netsim$frontend$cxxbridge1$CxxServerResponseWriter$put_ok_with_length(::netsim::frontend::CxxServerResponseWriter const &self, ::std::string const &mime_type, ::std::uint32_t length) noexcept {
  void (::netsim::frontend::CxxServerResponseWriter::*put_ok_with_length$)(::std::string const &, ::std::uint32_t) const = &::netsim::frontend::CxxServerResponseWriter::put_ok_with_length;
  (self.*put_ok_with_length$)(mime_type, length);
}

void netsim$frontend$cxxbridge1$CxxServerResponseWriter$put_chunk(::netsim::frontend::CxxServerResponseWriter const &self, ::rust::Slice<::std::uint8_t const> chunk) noexcept {
  void (::netsim::frontend::CxxServerResponseWriter::*put_chunk$)(::rust::Slice<::std::uint8_t const>) const = &::netsim::frontend::CxxServerResponseWriter::put_chunk;
  (self.*put_chunk$)(chunk);
}

void netsim$frontend$cxxbridge1$CxxServerResponseWriter$put_ok(::netsim::frontend::CxxServerResponseWriter const &self, ::std::string const &mime_type, ::std::string const &body) noexcept {
  void (::netsim::frontend::CxxServerResponseWriter::*put_ok$)(::std::string const &, ::std::string const &) const = &::netsim::frontend::CxxServerResponseWriter::put_ok;
  (self.*put_ok$)(mime_type, body);
}

void netsim$frontend$cxxbridge1$CxxServerResponseWriter$put_error(::netsim::frontend::CxxServerResponseWriter const &self, ::std::uint32_t error_code, ::std::string const &error_message) noexcept {
  void (::netsim::frontend::CxxServerResponseWriter::*put_error$)(::std::uint32_t, ::std::string const &) const = &::netsim::frontend::CxxServerResponseWriter::put_error;
  (self.*put_error$)(error_code, error_message);
}
} // extern "C"
} // namespace frontend
