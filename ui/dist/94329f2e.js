import{i as t,_ as e,s as i,y as o,e as r}from"./48895b41.js";import{e as s}from"./270e41ec.js";import{s as a}from"./d972766a.js";let d=class extends i{constructor(){super(...arguments),this.yaw=-15,this.pitch=-15,this.roll=0,this.posZ=0,this.color=t`red`,this.size=t`30px`,this.controls=!1,this.highlighted=!1,this.handleOrientationEvent=t=>{const{detail:e}=t;e.deviceSerial===this.id&&this.controls&&("yaw"===e.type?this.yaw=e.value:"pitch"===e.type?this.pitch=e.value:this.roll=e.value)}}connectedCallback(){super.connectedCallback(),a.registerObserver(this),window.addEventListener("orientationEvent",this.handleOrientationEvent)}disconnectedCallback(){window.removeEventListener("orientationEvent",this.handleOrientationEvent),a.removeObserver(this),super.disconnectedCallback()}onNotify(t){var e;this.highlighted=t.selectedSerial===this.id;for(const i of t.devices)if(i.deviceSerial===this.id)return void(this.posZ=100*(null!==(e=i.position.z)&&void 0!==e?e:0))}render(){return o`
      <style>
        :host {
          font-size: ${this.size};
          --color: ${this.color};
